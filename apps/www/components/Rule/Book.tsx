import { Wrapper, List, Text, Strong, Caption } from '../Docs'
import { Typo, Tabs, Table } from '@zzz-picker/components/v2'
  ...
  return (
    <div className={props.className}>
      ...
      <div className="flex flex-col gap-8">
        ...
        <Activity mode={gameRuleTab === '언리미티드(UL) 공허사냥꾼 경기' ? 'visible' : 'hidden'}>
          <Wrapper title="언리미티드(UL) 공허사냥꾼 경기">
            <List
              ...
              list={[
                ...
                <Text>
                  예능식 참가자는 선발과정 및 진행과정에서 <Strong>판정패</Strong> 될 수 있습니다.
                </Text>,
              ]}
            />
          </Wrapper>
