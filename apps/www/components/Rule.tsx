  ...
  return (
    <List
      ...
      list={[
        <>
          <Text>
            S급 픽업 <Caption>(예: 6돌파 사용시 = 7 Cost)</Caption>
          </Text>
          <List
            className="list-disc"
            list={[
              <Text>
                사용시: <Strong>1 Cost</Strong>
              </Text>,
              <Text>
                돌파당: <Strong>+1 Cost</Strong>
              </Text>,
            ]}
          />
        </>,
        <>
          <Text>
            S급 상시 <Caption>(예: 6돌파 사용시 = 0 Cost)</Caption>
          </Text>
          <List
            className="list-disc"
            list={[
              <Text>
                사용시: <Strong>0 Cost</Strong>
              </Text>,
              <Text>
                돌파당: <Strong>+0 Cost</Strong>
              </Text>,
            ]}
          />
        </>,
        <>
          <Text>
            A급 상시 <Caption>(예: 6돌파 사용시 = 0 Cost)</Caption>
          </Text>
          <List
            className="list-disc"
            list={[
