...
const BossInfo: React.FC = () => {
  ...
  const bossData = useMemo(() => {
    return pipe(state.common.boss!, (bossId) => boss.get(bossId))
  }, [boss, state.common.boss])
        ...
        <div className="mt-auto">
          <div className="flex items-end">
            ...
            <Typo.Body className="flex-1 heading-4xl flex gap-2 items-end justify-end text-primary">
              ...
              <span className="text-primary heading-4xl text-7xl tabular-nums">{sum(counts)}</span>
