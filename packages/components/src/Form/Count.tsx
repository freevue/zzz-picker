...
const Count: React.FC<Props> = (props) => {
  ...
  return (
    <div className="flex items-center w-full border-2 border-foreground overflow-hidden rounded-lg">
      <Button className="p-2 bg-foreground group" value="-1" onClick={onButtonClick} type="button">
        <Icons.Minus className="stroke-base size-8 group-hover:stroke-secondary" />
      </Button>
      ...
      <Button className="p-2 bg-foreground group" value="1" onClick={onButtonClick} type="button">
        <Icons.Plus className="stroke-base size-8 group-hover:stroke-secondary" />
      </Button>
    </div>
  )
}
